...
#   前指数は PDF 確認済。B(活性化・吸着エネルギー) は Graaf 1988 Table 6 で最終確認推奨。
PARAMS = {
    "k_A":   (2.69e7,  -109900.0),   # 反応A 速度
    "k_B":   (7.31e8,  -123400.0),   # 反応B 速度
    "k_C":   (4.36e2,   -65200.0),   # 反応C 速度
    "K_CO":  (7.99e-7,   58753.0),   # [bar^-1]
    "K_CO2": (1.02e-7,   67132.0),   # [bar^-1]
    "K_H2O_over_sqrtK_H2": (4.13e-11, 104500.0),  # [bar^-0.5]
}
